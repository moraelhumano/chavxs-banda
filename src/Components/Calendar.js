...
class DescriptionText extends Component{
    render() {
        return (
        <>
       <section className="max-w-5xl bg-white rounded-2xl p-6 mx-auto container-services flex-col my-12">
            <Zoom>
                <div className="title-section text-center flex-col">
                <h3 className="text-7xl md:text-3xl text-gray-600 text-center font-bold leading-none">
                        EL JAM DE STAND UP
                </h3>
                <h4 className="text-lg md:text-2xl text-gray-600 mt-2 text-center font-light leading-none">MARKETEATRO ROMA</h4>
                </div>
            </Zoom>  
            <section className="container min-w-7xl   mx-auto mt-12 flex flex-col md:flex-row wrap-own">
            <Bounce right>
            ...
            <Bounce left>
            <div className="w-full md:w-1/2 mt-8 md:mt-0 text-gray-600 mb-8 md:mb-0 text-lg md:text-left flex justify-start">
            <div class="w-full flex flex-col justify-start">
                <div className=" text-center md:text-left ">
                    <p className="text-gray-600 text-xl font-bold">ANA JULIA / OCTUBRE 21 / 21:00 HRS</p>
                ...
                <div className="mt-8 text-center md:text-left">
                    <p className="text-gray-600 font-bold text-xl">RAY CONTERAS / OCTUBRE 28 / 21:00 HRS</p>
                ...
                <div className="mt-8 text-center md:text-left">
                    ...
                    <p className="text-gray-600 font-bold text-xl">LEA Y KIKE VAZQUEZ / NOVIEMBRE 4 / 21:00 HRS</p>
                ...
                <div className="mt-8 text-center md:text-left">
                    ...
                    <p className="text-gray-600 font-bold text-xl">MARCELA LEUCONA / NOVIEMBRE 11 / 21:00 HRS</p>
                        <button class="mx-auto lg:mx-0 py-2 text-white font-bold bg-blue mt-2 px-4 border bg-primary-color content-center rounded">
                            COMPRA TUS BOLETOS
                        </button>
                    </a>
